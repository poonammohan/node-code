...
{
& "C:\Program Files (x86)\IAR Systems\Embedded Workbench 8.3\common\bin\cspybat" -f "E:\3slnode-stmicro\LT.LED0038.16_FW\EWARM\settings\HRTIM_test_master.HRTIM_test_master.general.xcl" --debug_file=$debugfile --backend -f "E:\3slnode-stmicro\LT.LED0038.16_FW\EWARM\settings\HRTIM_test_master.HRTIM_test_master.driver.xcl" 
}
